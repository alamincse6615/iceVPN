...
import 'package:securevpn/screen/paidServer/PaidServer.dart';
import 'package:securevpn/screen/contact/Contact.dart';
...
class _MyHomePageState extends State<Home> {
  ...
  void didChangeDependencies() {
    if (init) {
      ...
      passwordList = Provider.of<Vpns>(context,listen: false).paidVpnPassList;
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                        ...
                        validator: (value) {
                          return value.isNotEmpty ? null : "Code isn't empty";
                        },
                        decoration:
                        InputDecoration(hintText: "Please Enter Secret Key"),
                      ),
                    ],
                  )),
                  ...
                  child: TextButton(
                    onPressed: (){
                      if(_formKey.currentState.validate()){
                        if(passCheck(_textEditingController.text, passwordList)){
                          Navigator.push(context,
                            MaterialPageRoute(builder: (context) =>PaidServer()),
                          );
                        }else{
                        ...
                        /*for (var password in passwordList) {
                          if(password.compareTo(_textEditingController.text)==0){
                            Navigator.push(context,
                              MaterialPageRoute(builder: (context) =>PaidServer()),
                            );
                          }else{
...
bool passCheck(var password, List<String> list){
