...
class PaidServer extends StatefulWidget {
  static String routeName = '/home';
  PaidServer({Key key}) : super(key: key);
  @override
...
class _MyHomePageState extends State<PaidServer> {
  ...
  void didChangeDependencies() {
    if (init) {
      _PaidVpns = Provider.of<Vpns>(context, listen: false).paidvpns;
  ...
  Widget _dropDownItem() {
    return Theme(
      ...
      child: DropdownButton<Vpn>(
        ...
        items: _PaidVpns.map<DropdownMenuItem<Vpn>>((Vpn value) {
